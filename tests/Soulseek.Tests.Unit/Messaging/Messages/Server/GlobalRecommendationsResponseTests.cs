// <copyright file="GlobalRecommendationsResponseTests.cs" company="JP Dillingham">
...
namespace Soulseek.Tests.Unit.Messaging.Messages
{
    ...
    public class GlobalRecommendationsResponseTests
    {
        ...
        {
            GlobalRecommendationsResponse response = null;

            var ex = Record.Exception(() => response = new GlobalRecommendationsResponse(recommendations, unrecommendations));
        ...
        {
            var response = new GlobalRecommendationsResponse(null, null);
        ...
        public void Parse_Throws_MessageException_On_Code_Mismatch()
        {
            ...
            var ex = Record.Exception(() => GlobalRecommendationsResponse.FromByteArray(msg));
        ...
        public void Parse_Returns_Expected_Data(List<(string Recommendation, int Count)> recommendations, List<(string Unrecommendation, int Count)> unrecommendations)
        {
            ...
            var response = GlobalRecommendationsResponse.FromByteArray(builder.Build());
        ...
        public void Parse_Returns_Expected_Data_Given_Negative_Counts(string unrecommendation, int count)
        {
            ...
            var response = GlobalRecommendationsResponse.FromByteArray(msg);
