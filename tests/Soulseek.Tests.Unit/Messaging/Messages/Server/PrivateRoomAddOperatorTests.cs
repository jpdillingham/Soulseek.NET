// <copyright file="PrivateRoomAddOperatorTests.cs" company="JP Dillingham">
...
namespace Soulseek.Tests.Unit.Messaging.Messages
{
    ...
    public class PrivateRoomAddOperatorTests
    {
        [Trait("Category", "Instantiation")]
        [Theory(DisplayName = "Instantiates with the given data"), AutoData]
        public void Instantiates_With_The_Given_Data(string roomName, string username)
        {
            PrivateRoomAddOperator response = null;

            var ex = Record.Exception(() => response = new PrivateRoomAddOperator(roomName, username));
        ...
        public void Parse_Throws_MessageException_On_Code_Mismatch()
        {
            ...
            var ex = Record.Exception(() => PrivateRoomAddOperator.FromByteArray(msg));
        ...
        public void Parse_Returns_Expected_Data_On_Success(string roomName, string username)
        {
            ...
            var response = PrivateRoomAddOperator.FromByteArray(msg);
