// <copyright file="PrivilegedUserNotificationTests.cs" company="JP Dillingham">
...
namespace Soulseek.Tests.Unit.Messaging.Messages
{
    ...
    public class PrivilegedUserNotificationTests
    {
        ...
        public void Parse_Throws_MessageException_On_Code_Mismatch(string username)
        {
            ...
            var ex = Record.Exception(() => PrivilegedUserNotification.FromByteArray(msg));
