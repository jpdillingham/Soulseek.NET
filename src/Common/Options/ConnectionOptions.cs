...
namespace Soulseek
{
    ...
    public class ConnectionOptions
    {
        ...
        public ConnectionOptions(int readBufferSize = 8192, int writeBufferSize = 65536, int connectTimeout = 65536, int inactivityTimeout = 15000)
        {
        ...
        /// <summary>
        ///     Gets the read buffer size for underlying TCP connections. (Default = 65536).
        /// </summary>
        public int ReadBufferSize { get; }

        /// <summary>
        ///     Gets the write buffer size for underlying TCP connections. (Default = 65536).
        /// </summary>
