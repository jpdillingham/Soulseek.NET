...
namespace Soulseek.Network.Tcp
{
    ...
    internal static class ITcpClientExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when the proxy or destination port is not within the valid port range 0-65535.</exception>
        ...
        internal static Task<(string ProxyAddress, int ProxyPort)> ConnectThroughProxyAsync(
            ...
            CancellationToken? cancellationToken = null)
        {
            ...
            return ConnectThroughProxyInternalAsync(client, proxyAddress, proxyPort, destinationAddress, destinationPort, cancellationToken ?? CancellationToken.None, username, password);
        }

        private static async Task<(string ProxyAddress, int ProxyPort)> ConnectThroughProxyInternalAsync(
            ITcpClient client,
            IPAddress proxyAddress,
            int proxyPort,
            IPAddress destinationAddress,
