...
namespace Soulseek.NET
{
    ...
    public class SoulseekClientOptions
    {
        ...
        /// <summary>
        ///     Gets or sets the minimum level of diagnostic messages to be generated by the client.  (Default = None).
        /// </summary>
        public DiagnosticLevel MinimumDiagnosticLevel { get; set; } = DiagnosticLevel.None;
