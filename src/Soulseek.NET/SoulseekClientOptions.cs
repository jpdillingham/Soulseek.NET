...
namespace Soulseek.NET
{
    ...
    public class SoulseekClientOptions
    {
        ...
        /// <param name="tokenFactoryStart">the starting value for the download and search token factory.</param>
            ...
            ConnectionOptions transferConnectionOptions = null)
        {
            ...
            TokenFactoryStart = tokenFactoryStart;
        ...
        /// <summary>
        ///     Gets the starting value for the download and search token factory. (Default = 0);
        /// </summary>
        public int TokenFactoryStart { get; }
