...
namespace Soulseek.Messaging.Messages
{
    ...
    public class SearchResponse
    {
        ...
        internal SearchResponse(SearchResponseResponse response)
            : this(response.Username, response.Token, response.FileCount, response.FreeUploadSlots, response.UploadSpeed, response.QueueLength, response.Files)
        {
        }
