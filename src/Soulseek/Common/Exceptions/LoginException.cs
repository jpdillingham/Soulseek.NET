// <copyright file="LoginException.cs" company="JP Dillingham">
...
namespace Soulseek.Exceptions
{
    ...
    public class LoginException : SoulseekClientException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LoginException"/> class with a specified error message and a
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LoginException"/> class with serialized data.
        /// </summary>
    ...
    public class LoginRejectedException : LoginException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LoginRejectedException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LoginRejectedException"/> class with a specified error message and a
        ///     reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        /// <param name="innerException">
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LoginRejectedException"/> class with serialized data.
        /// </summary>
        /// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
        protected LoginRejectedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
