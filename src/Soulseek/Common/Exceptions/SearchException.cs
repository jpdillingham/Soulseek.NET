// <copyright file="SearchException.cs" company="JP Dillingham">
...
namespace Soulseek.Exceptions
{
    ...
    /// <summary>
    ///     Represents errors that occur while performing a network file search.
    /// </summary>
    ...
    public class SearchException : SoulseekClientException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SearchException"/> class with a specified error message and a
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SearchException"/> class with serialized data.
        /// </summary>
