...
namespace Soulseek.Exceptions
{
    ...
    /// <summary>
    ///     Represents errors that occur while joining a chat room.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [Serializable]
    public class RoomJoinException : SoulseekClientException
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomJoinException"/> class.
        /// </summary>
        public RoomJoinException()
            : base()
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomJoinException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomJoinException"/> class with a specified error message and a
        ///     reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        /// <param name="innerException">
        ...
        ///     inner exception is specified.
        /// </param>
        public RoomJoinException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomJoinException"/> class with serialized data.
        /// </summary>
        /// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
        protected RoomJoinException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
    ...
    /// <summary>
    ///     Represents errors that occur while leaving a chat room.
    /// </summary>
    [ExcludeFromCodeCoverage]
    [Serializable]
    public class RoomLeaveException : SoulseekClientException
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomLeaveException"/> class.
        /// </summary>
        public RoomLeaveException()
            : base()
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomLeaveException"/> class with a specified error message.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public RoomLeaveException(string message)
            : base(message)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomLeaveException"/> class with a specified error message and a
        ///     reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        /// <param name="innerException">
        ...
        ///     inner exception is specified.
        /// </param>
        public RoomLeaveException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="RoomLeaveException"/> class with serialized data.
        /// </summary>
        /// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
        protected RoomLeaveException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
