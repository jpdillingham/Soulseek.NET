// <copyright file="ChangePasswordException.cs" company="JP Dillingham">
...
namespace Soulseek.Exceptions
{
    ...
    [Serializable]
    public class ChangePasswordException : SoulseekClientException
    {
        /// <summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ChangePasswordException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ChangePasswordException"/> class with a specified error message and a
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ChangePasswordException"/> class with serialized data.
        /// </summary>
